...
export const blogSeed: BlogPost[] = [
  ...
  },
  {
    ...
    content:
      "Your puppy's first month is critical for building lifelong health and habits. Start vaccinations at 6-8 weeks and follow the full schedule through 16 weeks. Stock up on age-appropriate puppy food, a properly fitted collar, a crate for house-training, and safe chew toys. Schedule a first vet visit within the first week to establish a baseline and discuss deworming and microchipping. Socialization matters too — safe, controlled exposure to new people and environments builds a confident, well-adjusted dog.",
  },
];
