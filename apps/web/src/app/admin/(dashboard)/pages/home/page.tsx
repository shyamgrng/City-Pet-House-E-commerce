...
export default function AdminHomePage() {
  ...
  return (
    <div className="max-w-[640px]">
      ...
      <SectionLabel hint="The long promo banner between Today's Deals and Pet Food. Recommended size: 1400×280px.">
        Hot Sales Banner
      </SectionLabel>
      <Card>
        <ImageUploadField
      ...
      <SectionLabel hint="The delivery-coverage strip above Shop by Brand. Recommended size: 1400×280px.">Delivery Banner</SectionLabel>
      <Card>
        <ImageUploadField
