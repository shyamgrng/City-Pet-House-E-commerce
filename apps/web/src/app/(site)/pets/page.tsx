        ...
        {similar.length > 0 && (
          <>
            ...
            <div className="grid grid-cols-2 sm:grid-cols-4 gap-3.5">
              {similar.map((p) => (
                <div key={p.id} onClick={() => selectPet(p)} className="rounded-[10px] overflow-hidden cursor-pointer">
    ...
    <div className="px-8 py-7">
      ...
      {filtered.length === 0 ? (
        ...
        <div className="grid grid-cols-2 sm:grid-cols-4 gap-4">
          {filtered.map((p) => (
            <div key={p.id} onClick={() => selectPet(p)} className="rounded-xl overflow-hidden cursor-pointer">
