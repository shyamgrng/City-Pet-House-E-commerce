  ...
  return (
    <div className="bg-[#FDFEFE]">
      ...
      <div className="flex flex-wrap gap-3.5 px-8 pt-4 pb-6">
        {categories.map((cat) => (
          <Link
            ...
            className="flex-1 min-w-[110px] flex flex-col items-center gap-2 cursor-pointer transition-transform duration-200 hover:scale-105"
          >
      ...
      <div className="pt-1">
        ...
        {/* Microchip banner */}
        <div className="mx-8 mb-7 aspect-[1400/280] rounded-xl relative overflow-hidden flex flex-col items-start justify-center px-8 gap-3">
      ...
      {/* Hot Sales Banner */}
      <div className="mx-8 mt-[22px] mb-3.5 aspect-[1400/280] rounded-xl overflow-hidden relative flex items-center px-8">
