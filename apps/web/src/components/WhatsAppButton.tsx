...
export default function WhatsAppButton() {
  ...
  return (
    ...
    >
      ...
      <div className="w-12 h-12 sm:w-14 sm:h-14 rounded-full bg-[#25D366] shadow-[0_4px_14px_rgba(0,0,0,0.25)] flex items-center justify-center shrink-0">
        <svg viewBox="0 0 32 32" className="w-7 h-7 sm:w-8 sm:h-8" fill="#fff">
